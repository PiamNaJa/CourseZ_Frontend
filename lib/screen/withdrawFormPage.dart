...
class WithdrawForm extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final money = Get.arguments;
    final TextEditingController bankNumberController = TextEditingController();
    final TextEditingController moneyController = TextEditingController();
    final bool isTrueorPromptPay =
        title == 'ทรูวอลเล็ต' || title == 'พร้อมเพย์';
    bool moneyValidate = false;
    bool bankNumberValidate = false;
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Heading24px(text: 'ยอดเงินคงเหลือ $money บาท'),
              SizedBox(height: MediaQuery.of(context).size.height * 0.02),
              Row(
                  ...
                  children: [
                    Expanded(
                        child: Bt(
                            ...
                            color: primaryColor,
                            onPressed: () {
                              if (bankNumberValidate && moneyValidate) {
                                showDialog(
                                    context: context,
                                    builder: (context) {
                                      return AlertDialog(
